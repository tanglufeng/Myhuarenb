...
import com.abcs.huaqiaobang.view.lib.ScreenInfo;
import com.abcs.huaqiaobang.view.lib.WheelTime;
...
public class TimePopupWindow extends PopupWindow implements OnClickListener {
	...
	public TimePopupWindow(Context context, Type type) {
		...
		nowTime = (TextView) rootView.findViewById(R.id.txt_now);
		bj = rootView.findViewById(R.id.bj);
		// -----确定和取消按钮
