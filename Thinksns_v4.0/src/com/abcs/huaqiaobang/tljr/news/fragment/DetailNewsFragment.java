...
public class DetailNewsFragment extends Fragment implements OnClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        shareWeiXinPlatform = new ShareWeiXinPlatform(activity);
        ...
        if (isVisibleToUser) {
            ...
            activity.handler.postDelayed(new Runnable() {
                ...
                public void run() {
                    ...
                    if (!news.isLoadDetails() && !Constent.netType.equals("未知")) {
    ...
    public void getDetailNews(final Complete complete) {
        ...
        String params = "species=" + news.getSpecial() + "&id=" + news.getId() + "&time=" + news.getTime() + "&uid=" + pid;
    ...
    private void showPopupView() {
        if (popupWindow == null) {
            ...
            for (int i = 0; i < ly1.getChildCount(); i++) {
                final int m = i;
                ly1.getChildAt(i).setOnClickListener(new OnClickListener() {
