package com.abcs.huaqiaobang.tljr.zrclistview;
...
import com.abcs.huaqiaobang.util.APIUtil;
...
public class ZrcListView extends ZrcAbsListView {
	...
	public ZrcListView(Context context, AttributeSet attrs, int defStyle) {
		...
		TypedArray a = context.obtainStyledAttributes(attrs,
				R.styleable.HQBListView, defStyle, 0);
		final Drawable d = a.getDrawable(R.styleable.HQBListView_android_divider);
		if (d != null) {
			setDivider(d);
		}
		final int dividerHeight = a.getDimensionPixelSize(
				R.styleable.HQBListView_android_dividerHeight, 0);
		if (dividerHeight != 0) {
			setDividerHeight(dividerHeight);
		}
		mHeaderDividersEnabled = a.getBoolean(
				R.styleable.HQBListView_android_headerDividersEnabled, true);
		mFooterDividersEnabled = a.getBoolean(
				R.styleable.HQBListView_android_footerDividersEnabled, true);
		mItemAnimForTopIn = 0;
