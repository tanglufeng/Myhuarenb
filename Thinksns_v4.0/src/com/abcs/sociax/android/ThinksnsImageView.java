...
import com.abcs.sociax.unit.AsyncImageLoader;
import com.abcs.sociax.unit.ImageUtil;
import com.abcs.sociax.unit.ImageZoomView;
import com.abcs.sociax.unit.SimpleZoomListener;
import com.abcs.sociax.unit.ZoomState;
...
public class ThinksnsImageView extends ThinksnsAbscractActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		lyLoading = (LinearLayout) findViewById(com.abcs.sociax.android.R.id.ly_loading);
		// leftText = (TextView) findViewById(R.id.group_flip);
		// rightText = (TextView) findViewById(R.id.group_right_btn);
		imageZoomView = (ImageZoomView) findViewById(com.abcs.sociax.android.R.id.image_data);
		zoomCtrl = (ZoomControls) findViewById(com.abcs.sociax.android.R.id.zoomCtrl);
			...
			if (msg.what == 1) {
				if (drawable == null) {
					Toast.makeText(ThinksnsImageView.this,
							com.abcs.sociax.android.R.string.wc_itme_img_error, Toast.LENGTH_LONG)
							.show();
					return;
				}
	...
	protected int getLayoutId() {
		return com.abcs.sociax.android.R.layout.imageshow;
	}

	@Override
	public String getTitleCenter() {
		return this.getString(com.abcs.sociax.android.R.string.imageshow);
	}

	@Override
	protected CustomTitle setCustomTitle() {
		return new RightIsButton(this, this.getString(com.abcs.sociax.android.R.string.imagesave));
	}

	@Override
	public int getRightRes() {
		return com.abcs.sociax.android.R.drawable.button_send;
	}
