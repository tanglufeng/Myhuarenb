...
public class ChatPicture extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(com.abcs.sociax.android.R.layout.activity_chat_picture);
		photoView = (PhotoView) findViewById(com.abcs.sociax.android.R.id.chat_pic);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(com.abcs.sociax.android.R.menu.chat_picture, menu);
		return true;
	}
