...
public class SociaxWebView extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(com.abcs.sociax.android.R.layout.sociax_web);

		webView = (WebView) findViewById(com.abcs.sociax.android.R.id.web_view);

		buttonBack = (Button) findViewById(com.abcs.sociax.android.R.id.btn_back);
		buttonForward = (Button) findViewById(com.abcs.sociax.android.R.id.btn_forward);
		imBtnHome = (ImageButton) findViewById(com.abcs.sociax.android.R.id.im_btn_home);
