package com.abcs.sociax.android.home;
	...
	private void setOnClickListener() {
		findViewById(R.id.newsfeed_flip).setOnClickListener(
				new OnClickListener() {
					...
					public void onClick(View v) {
						// TODO Auto-generated method stub
						// Thinksns app = (Thinksns) SettingsActivity.this
						// .getApplicationContext();
						// app.startActivity(SettingsActivity.this,
						// MainGridActivity.class, null);
						// Anim.exit(SettingsActivity.this);
						finish();
					}
				});
		...
		mFeedBack.setOnPreferenceClickListener(new OnPreferenceClickListener() {
			...
			public boolean onPreferenceClick(Preference preference) {
				...
				Intent i = null;//new Intent(SettingsActivity.this,WeiboCreateActivity.class);
				i.putExtra("type", "suggest");
				startActivity(i);
				Anim.in(SettingsActivity.this);
				return false;
			}
		});
...
//					Toast.makeText(SettingsActivity.this, "没有更新",
//							Toast.LENGTH_SHORT).show();
//					break;
//				case 2: // none wifi
...
//					break;
//				case 3: // time out
//					Toast.makeText(SettingsActivity.this, "超时",
//							Toast.LENGTH_SHORT).show();
//					break;
//				}
//			}
