...
import com.abcs.sociax.t4.android.setting.ActivityAboutUs;
import com.thinksns.sociax.thinksnsbase.exception.ApiException;
import com.abcs.sociax.unit.UpdateManager;
...
public class SettingsActivity extends PreferenceActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(com.abcs.sociax.android.R.layout.set_preference_main);
		addPreferencesFromResource(com.abcs.sociax.android.R.xml.settings);
	...
	private void setOnClickListener() {
		findViewById(com.abcs.sociax.android.R.id.newsfeed_flip).setOnClickListener(
				new OnClickListener() {
					@Override
		...
		mClearCache
				.setOnPreferenceClickListener(new OnPreferenceClickListener() {
					...
					public boolean onPreferenceClick(Preference preference) {
						...
						alertDialog.setTitle(com.abcs.sociax.android.R.string.clear_cache_alert_title);
						alertDialog.setMessage(com.abcs.sociax.android.R.string.clear_cache_alert);
						alertDialog.setPositiveButton(com.abcs.sociax.android.R.string.ok,
						...
						alertDialog.setNegativeButton(com.abcs.sociax.android.R.string.cancel, null);
						alertDialog.create();
						alertDialog.show();
						return false;
					}
		...
		public void handleMessage(Message msg) {
			...
			if (msg.arg1 == 1) {
				...
				if (mUpdateManager.checkUpdateInfo(vInfo) > 0) {
					Toast.makeText(getApplication(), com.abcs.sociax.android.R.string.no_new_version,
