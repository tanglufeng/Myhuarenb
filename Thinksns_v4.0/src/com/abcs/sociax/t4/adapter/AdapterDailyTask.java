...
public class AdapterDailyTask extends BaseAdapter {
	...
	public AdapterDailyTask(Context context,
							ArrayList<ModelDailyOrMainTask> dailyTasks) {
		super();
		this.context = context;
		this.dailyTasks = dailyTasks;
		application = (Thinksns) Thinksns.getContext();
	}
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			convertView = LayoutInflater.from(context).inflate(
					R.layout.list_item_daily_task, null);
		...
		// 修改分值的颜色
		SpannableString styledText = new SpannableString(holder.tv_main_task_detail_goal.getText());
		...
		holder.tv_main_task_detail_goal.setText(styledText,TextView.BufferType.SPANNABLE);
