...
import com.abcs.sociax.t4.android.function.FunctionPhotoFullScreen;
import com.abcs.sociax.t4.android.img.ActivityViewPager;
import com.abcs.sociax.t4.android.user.ActivityUserPhoVedlist;
...
public class AdapterUserInfoAlbum extends AdapterSociaxList {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (Integer.valueOf(user.getPhotoCount()) > 0) {
            holder.tv_photo_count.setText(user.getPhotoCount());
        }
        if (Integer.valueOf(user.getVdeioCount()) > 0) {
