 ...
 * @date 2014-11-4
 */
public class AdapterFindPeopleByVerify extends AdapterUserFollowingList {
    String verify_id;

    public AdapterFindPeopleByVerify(FragmentSociax fragment,
                                     ListData<SociaxItem> list, int uid, String verify_id) {
    ...
    public ListData<SociaxItem> refreshNew(int count)
        ...
        return (ListData<SociaxItem>) getApiUser().searchUserByVerifyCode(
                verify_id, 0, httpListener);
    }
    ...
    public ListData<SociaxItem> refreshFooter(SociaxItem obj)
            ...
            DataInvalidException {
        return (ListData<SociaxItem>) getApiUser().searchUserByVerifyCode(
                verify_id, getMaxid(), httpListener);
    }
            ...
            viewHolder.tv_user_add.setOnClickListener(new OnClickListener() {
                ...
                public void onClick(View v) {
                    FunctionChangeFollow fcChangeFollow = new FunctionChangeFollow(
                            context, AdapterFindPeopleByVerify.this, v);
