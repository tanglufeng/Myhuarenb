...
import com.abcs.sociax.api.ApiUsers;
...
import com.abcs.sociax.t4.android.Listener.ListenerRefreshComplete;
        ...
        if (refresh != null) {
            ...
            if (null != isRefreshActivity
                ...
                Anim.refresh(
                        context,
                        refresh,
                        com.abcs.sociax.android.R.drawable.spinner_black);
            if (null != isRefreshActivity
...
//		handler.sendMessage(msg);
    ...
    public void addHeader(ListData<SociaxItem> list) {
        ...
        if (list.size() > 0) {
            ...
            if (!isHideFootToast)
                Toast.makeText(context, com.abcs.sociax.android.R.string.refresh_error,Toast.LENGTH_SHORT).show();
    ...
    public void changeListData(ListData<SociaxItem> list) {
        ...
        if (this.list.size() == 0 && !isHideFootToast) {
            Toast.makeText(context,
                    com.abcs.sociax.android.R.string.refresh_error,
