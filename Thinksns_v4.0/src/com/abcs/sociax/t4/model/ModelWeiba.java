package com.abcs.sociax.t4.model;
...
public class ModelWeiba extends SociaxItem implements Parcelable{
	...
	private int weiba_id,	// 微吧id
			...
			admin_uid,		// 管理员id
			cid;
	private String weiba_name,weiba_name_tag,	// 微吧名字
	...
	public ModelWeiba(JSONObject data) {
		try {
			...
			if (data.has("tag")) {
				this.setWeiba_name_tag(data.getString("tag"));
			}
			if (data.has("ctime")) {
	...
	public String getWeiba_name_tag() {
		return weiba_name_tag;
	}

	public void setWeiba_name_tag(String weiba_name_tag) {
		this.weiba_name_tag = weiba_name_tag;
	}
	...
	public void writeToParcel(Parcel dest, int flags) {
		...
		dest.writeString(weiba_name_tag);
	...
	public ModelWeiba(Parcel source) {
		...
		this.weiba_name_tag = source.readString();
