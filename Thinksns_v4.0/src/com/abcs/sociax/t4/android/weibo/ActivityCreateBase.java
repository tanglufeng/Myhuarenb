...
import com.abcs.sociax.t4.android.img.PhotoActivity;
import com.abcs.sociax.t4.android.map.ActivityGetMyLocation;
import com.abcs.sociax.t4.android.popupwindow.PopUpWindowAlertDialog;
import com.abcs.sociax.t4.android.popupwindow.PopupWindowListDialog;
import com.abcs.sociax.t4.android.popupwindow.PopupWindowLocation;
import com.abcs.sociax.t4.android.temp.SelectImageListener;
import com.abcs.sociax.t4.android.topic.AtTopicActivity;
import com.abcs.sociax.t4.android.user.ActivityAtUserSelect;
import com.abcs.sociax.t4.android.video.ActivityVideoDetail;
...
import com.abcs.sociax.t4.service.ServiceUploadWeibo;
...
public class ActivityCreateBase extends ThinksnsAbscractActivity implements View.OnClickListener,
    ...
    protected static final int GET_GOOGLE_LOCATION = 6;
        ...
        switch (v.getId()) {
            ...
            case R.id.tv_get_my_location:
                if (v.getTag() == null) {
                    ...
                    if (ThinksnsActivity.canOpenGoogle){
                        try {


                            PlacePicker.IntentBuilder intentBuilder = new PlacePicker.IntentBuilder();
                            Intent gintent = intentBuilder.build(ActivityCreateBase.this);
                            // Start the Intent by requesting a result, identified by a request code.
                            startActivityForResult(gintent, GET_GOOGLE_LOCATION);
...
//                            Toast.makeText(ActivityCreateBase.this, "Google Play Services is not available.1111",
//                                    Toast.LENGTH_LONG)
//                                    .show();
                            GooglePlayServicesUtil
                                    .getErrorDialog(e.getConnectionStatusCode(),ActivityCreateBase.this, 0);
                        } catch (GooglePlayServicesNotAvailableException e) {
                            startActivityForResult(new Intent(this, ActivityGetMyLocation.class), GET_LOCATION);
//                            Toast.makeText(ActivityCreateBase.this, "Google Play Services is not available.22222",
//                                    Toast.LENGTH_LONG)
//                                    .show();
                        }
                    }else{
...
//        view.setEnabled(true);
    ...
    protected Intent getUploadIntent() {
        ...
        if (type == AppConstant.CREATE_ALBUM_WEIBO) {
            ...
            Log.i(TAG, "getUploadIntent: ========imageStr"+imageStr);
        } else if (type == AppConstant.CREATE_VIDEO_WEIBO) {
...
//                    setMedia(HAS_IMAGE);
                ...
                case GET_GOOGLE_LOCATION:

                    final Place place = PlacePicker.getPlace(data, ActivityCreateBase.this);
                    Toast.makeText(ActivityCreateBase.this, "adress"+place.getAddress()+"latitude:"+place.getLatLng().latitude+"longitude:"+place.getLatLng().longitude, Toast.LENGTH_SHORT).show();
