...
import com.abcs.sociax.db.AtMeSqlHelper;
import com.abcs.sociax.db.AttachSqlHelper;
import com.abcs.sociax.db.ChannelSqlHelper;
import com.abcs.sociax.db.ChatMsgSqlhelper;
import com.abcs.sociax.db.FavoritWeiboSqlHelper;
import com.abcs.sociax.db.MobileAppSqlHelper;
import com.abcs.sociax.db.MyCommentSqlHelper;
import com.abcs.sociax.db.MyMessageSqlhelper;
import com.abcs.sociax.db.RemindSqlHelper;
import com.abcs.sociax.db.SitesSqlHelper;
import com.abcs.sociax.db.SqlHelper;
...
import com.abcs.sociax.t4.android.db.SQLHelperChatMessage;
import com.abcs.sociax.t4.android.db.SQLHelperWeiboDraft;
import com.abcs.sociax.t4.model.ModelUser;
import com.abcs.sociax.t4.service.ServiceUnReadMessage;
...
public class Thinksns extends BaseApplication {
    ...
    private static List<CeSu> ceSuList=new ArrayList<>();
    private static List<PinLeiRight.DatasBean.Class3Bean> class3=new ArrayList<>();
    ...
    public static List<CeSu> getCeSuList() {
        return ceSuList;
    }

    public static void setCeSuList(List<CeSu> ceSuList) {
        Thinksns.ceSuList = ceSuList;
    }
    public static List<PinLeiRight.DatasBean.Class3Bean> getTabList() {
        return class3;
    }

    public static void setTabList(List<PinLeiRight.DatasBean.Class3Bean> ceSuList) {
        Thinksns.class3 = class3;
    }
    ...
    public void onCreate() {
        super.onCreate();
        LogUtil.i("whystar","whystar****Thinksns***********************");
        //初始化聊天管理
