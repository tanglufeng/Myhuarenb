...
import com.abcs.sociax.t4.android.weiba.ActivityPostCommon;
import com.abcs.sociax.t4.android.weiba.ActivityWeibaDetail;
...
public class AppendPost extends AppendSociax {
    ...
    public void appendPostListData(HolderSociax holder, final ModelPost post) {
        ...
        if (TextUtils.isEmpty(post.getContent())) {
            ...
            com.abcs.sociax.t4.unit.UnitSociax.showContentLinkViewAndLinkMovement(post.getContent(), holder.tv_post_info);
