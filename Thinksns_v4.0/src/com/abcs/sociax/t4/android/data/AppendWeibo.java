package com.abcs.sociax.t4.android.data;
...
import com.abcs.sociax.t4.android.Thinksns;import com.abcs.sociax.t4.android.channel.ActivityChannelWeibo;
import com.abcs.sociax.t4.android.fragment.FragmentWeibo;

import com.abcs.sociax.t4.android.function.FunctionChangeSociaxItemStatus;
import com.abcs.sociax.t4.android.img.ActivityViewPager;
import com.abcs.sociax.t4.android.img.UIImageLoader;
import com.abcs.sociax.t4.android.interfaces.WeiboListViewClickListener;
import com.abcs.sociax.t4.android.topic.ActivityTopicWeibo;
import com.abcs.sociax.t4.android.user.ActivityUserInfo_2;
import com.abcs.sociax.t4.android.weiba.ActivityPostDetail;
import com.abcs.sociax.t4.android.weibo.ActivityFindCicle;
import com.abcs.sociax.t4.android.weibo.ActivityWeiboDetail;
import com.abcs.sociax.t4.android.widget.roundimageview.RoundedImageView;
import com.abcs.sociax.t4.component.HolderSociax;
import com.abcs.sociax.t4.model.ModelImageAttach;
...
import com.abcs.sociax.t4.unit.DynamicInflateForWeibo;
...
import com.abcs.sociax.unit.TypeNameUtil;
...
//					.findViewById(R.id.rl_content_layout);
     ...
     */
    public void appendWeiboItemDataWithNoBackGround(final int position, final HolderSociax holder, final ModelWeibo currentWeibo) {
        ...
        if (currentWeibo.getType().equals("weiba_post")) {
            ...
            // 内容
            String content=currentWeibo.getContent();
        ...
        if (context instanceof ActivityHome||context instanceof ActivityFindCicle
