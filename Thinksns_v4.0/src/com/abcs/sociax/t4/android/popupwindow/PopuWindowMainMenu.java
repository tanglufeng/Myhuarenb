...
public class PopuWindowMainMenu extends PopupWindowsMainMenuConstructor
	...
	private List<PopuWindowsMainMenuConstructorItem> PopuItems = new ArrayList<PopuWindowsMainMenuConstructorItem>();
	 ...
	 *            Context
	 */
	public PopuWindowMainMenu(Context context) {
	 ...
	 */
	public PopuWindowMainMenu(Context context, int orientation) {
		super(context);
	 ...
	 */
	public PopuWindowsMainMenuConstructorItem getPopuItem(int index) {
	 ...
	 * 
	 * @param action
	 *            {@link PopuWindowsMainMenuConstructorItem}
	 */
	public void addPopuItem(PopuWindowsMainMenuConstructorItem action) {
		...
		container.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				if (mItemClickListener != null) {
					mItemClickListener.onItemClick(PopuWindowMainMenu.this,
							pos, actionId);
				}
	...
	public void show(View anchor) {
		...
		int showPopx = (screenWidth - rootWidth) / 2 /*- 5*/;
		...
		showArrow(((onTop) ? R.id.arrow_down : R.id.arrow_up), rootWidth / 2);

		setAnimationStyle(screenWidth, anchorRect.centerX(), onTop);
		Log.d(null, "坐标 " + location[0] + " " + location[1] + "  " + showPopx
				+ "   " + yPos);
		mWindow.showAtLocation(anchor, Gravity.NO_GRAVITY, showPopx, yPos);
	}
	...
	public void setOnDismissListener(
			PopuWindowMainMenu.OnDismissListener listener) {
	...
	public interface OnPopuItemClickListener {
		public abstract void onItemClick(PopuWindowMainMenu source, int pos,
				int actionId);
	}
