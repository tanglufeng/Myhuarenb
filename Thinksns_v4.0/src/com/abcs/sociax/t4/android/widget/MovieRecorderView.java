package com.abcs.sociax.t4.android.widget;
...
public class MovieRecorderView extends LinearLayout implements OnErrorListener {
	...
	public MovieRecorderView(Context context, AttributeSet attrs, int defStyle) {
		...
		int width = UnitSociax.getWindowWidth(context);
		int height = UnitSociax.getWindowHeight(context);
	...
	private void createRecordDir() {
		File sampleDir = new File(Environment.getExternalStorageDirectory() + File.separator + "ThinkSNS4.0/video/");
		if (!sampleDir.exists()) {
			sampleDir.mkdirs();
		}
		...
		try {
			...
			Log.i("MovieRecordView", mVecordFile.getAbsolutePath());
		} catch (IOException e) {
		}
	}
