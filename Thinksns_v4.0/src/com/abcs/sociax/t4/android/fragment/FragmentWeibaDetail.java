...
import com.abcs.sociax.db.WeibaSqlHelper;
import com.abcs.sociax.t4.adapter.AdapterPostList;
...
import com.abcs.sociax.t4.android.view.IWeibaDetailView;
import com.abcs.sociax.t4.android.weiba.ActivityPostDetail;
import com.abcs.sociax.t4.android.weiba.ActivityPostList;
import com.abcs.sociax.t4.android.weiba.ActivityWeibaCommon;
import com.abcs.sociax.t4.android.weiba.WeibaDetailPresenter;
...
import com.abcs.sociax.t4.unit.ButtonUtils;
import com.abcs.sociax.t4.unit.DynamicInflateForWeiba;
                    ...
                    if (detail != null) {
                        ...
                        if (isFollow) {
                         ...
                         //   int diggest = (Integer) detail.getJSONArray("weiba_digest").get(0);
                            int diggest = Integer.valueOf( detail.getJSONArray("weiba_digest").get(0)+"");  //edit by hao
                            if (diggest > 0) {
