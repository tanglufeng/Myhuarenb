package com.abcs.sociax.adapter;
...
import com.abcs.sociax.api.ApiContact;
import com.abcs.sociax.concurrent.Worker;
import com.abcs.sociax.gimgutil.AsyncImageLoader;
...
public class CategoryAdapter extends SociaxListAdapter {
	...
	public CategoryAdapter(ThinksnsAbscractActivity context,
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		/*
		 * if(getItem(position) instanceof ContactCategory){
		 * 
		 * }
		 */
	...
	public ListData<SociaxItem> refreshNew(int count)
			throws VerifyErrorException, ApiException, ListAreEmptyException,
			DataInvalidException {
		return getApiStatuses().getContactCategoryList(0);
	}
