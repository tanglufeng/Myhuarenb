package com.abcs.haiwaigou.view.zjzbanner;
...
import com.abcs.haiwaigou.view.zjzbanner.transformer.LMPageTransformer;
...
import com.abcs.haiwaigou.view.zjzbanner.utils.ViewPagerScroller;
import com.abcs.haiwaigou.view.zjzbanner.viewpager.HorizonVerticalViewPager;
import com.abcs.haiwaigou.view.zjzbanner.viewpager.MyViewPager;
...
public class LMBanners<T> extends FrameLayout implements ViewPager.OnPageChangeListener {
    ...
    private void initStyle(AttributeSet attrs, int defStyleAttr) {
        ...
        autoPlay = typedArray.getBoolean(R.styleable.LMBanners_auto_play2, true);//默认可以自动播放
