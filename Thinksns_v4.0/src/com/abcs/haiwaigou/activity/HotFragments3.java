...
public class HotFragments3 extends BaseFragment implements View.OnClickListener, RecyclerViewAndSwipeRefreshLayout.SwipeRefreshLayoutRefresh, HWGFragmentViewHolder.ItemOnClick {
    ...
    private PreviewHandler mHandler = new PreviewHandler((HotActivity3) getActivity());
    ...
    private HotActivity3 activity;


    public static HotFragments3 newInstance(String plateId, String objectName) {
        Bundle bundle = new Bundle();
        bundle.putSerializable("plate_id", plateId);
        bundle.putSerializable("objectName", objectName);
        HotFragments3 fragment = new HotFragments3();
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        if (bundle != null) {
            ...
            Log.i("zds","special_id="+special_id);
...
//                initTestAllDates();
    ...
    private class PreviewHandler extends Handler {
        ...
        private WeakReference<HotActivity3> ref;

        PreviewHandler(HotActivity3 activity) {
            ref = new WeakReference<>(activity);
        }

        @Override
        public void handleMessage(Message msg) {
            final HotActivity3 activity = ref.get();
