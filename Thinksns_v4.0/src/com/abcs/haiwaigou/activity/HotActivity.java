...
public class HotActivity extends BaseActivity implements View.OnClickListener, RecyclerViewAndSwipeRefreshLayout.SwipeRefreshLayoutRefresh, HWGFragmentViewHolder.ItemOnClick {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        isLuxury = getIntent().getBooleanExtra("isLuxury", false);
        ...
        if (isRemai) {
            ...
            try {
                ...
                Log.i("xuke112","keyword"+keyword);
            } catch (UnsupportedEncodingException e) {
                e.printStackTrace();
            }
        }
        hotHeaderView = new HotHeaderView(this);
        linearType.setVisibility(isSecond ? View.VISIBLE : View.GONE);
...
//            initText(t_text);
        ...
        if (isMain) {
            ...
            RelativeLayout.LayoutParams layoutParams = new RelativeLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, Util.dip2px(this, 180));
            img_banner.setLayoutParams(layoutParams);
            img_banner.setScaleType(ImageView.ScaleType.FIT_XY);
        }
    ...
    private EndlessRecyclerOnScrollListener mOnScrollListener = new EndlessRecyclerOnScrollListener() {
        ...
        public void onLoadNextPage(View view) {
            ...
            if (currentPage < totalPage) {
                // loading more
                RecyclerViewStateUtils.setFooterViewState(HotActivity.this, recyclerView, REQUEST_COUNT, LoadingFooter.State.Loading, null);
                requestData();
            } else {
                //the end
//                RecyclerViewStateUtils.setFooterViewState(HotActivity.this, recyclerView, REQUEST_COUNT, LoadingFooter.State.TheEnd, null);
            }
        }
    };
    ...
    private class PreviewHandler extends Handler {
        ...
        private WeakReference<HotActivity> ref;

        PreviewHandler(HotActivity activity) {
            ref = new WeakReference<>(activity);
        }

        @Override
        public void handleMessage(Message msg) {
            final HotActivity activity = ref.get();
    ...
    private void requestData() {
        ...
        new Thread() {
            ...
            public void run() {
                ...
                //模拟一下网络请求失败的情况
                if (NetworkUtils.isNetAvailable(HotActivity.this)) {
