...
//    boolean isLoadMore = false;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (view == null) {
            view = getLayoutInflater().inflate(R.layout.hwg_activity_hotspecial, null);
        }
                        ...
                        try {
                            ...
                            if (object.getInt("code") == 200) {
                                if (object.optString("datas").equals("1")) {
                                    ...
                                    Intent intent = new Intent(HotSpecialActivity.this, CartActivity2.class);
...
//    };
    ...
    private class PreviewHandler extends Handler {
        ...
        PreviewHandler(HotSpecialActivity activity) {
            ref = new WeakReference<>(activity);
        }

        @Override
        public void handleMessage(Message msg) {
            final HotSpecialActivity activity = ref.get();
