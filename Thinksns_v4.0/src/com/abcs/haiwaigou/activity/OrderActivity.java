...
import com.abcs.haiwaigou.fragment.OrderFragment;
...
//    OrderPayFragment orderPayFragment;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (view == null) {
            view = getLayoutInflater().inflate(R.layout.hwg_activity_order_list, null);
        }
...
//        viewPagerAdapter.getDatas().add(orderAllFragment);
//        viewPagerAdapter.getDatas().add(orderPayFragment);
//        viewPagerAdapter.getDatas().add(orderDeliverFragment);
//        viewPagerAdapter.getDatas().add(orderReceiveFragment);
//        viewPagerAdapter.getDatas().add(orderCompleteFragment);//已完成
//        viewPagerAdapter.getDatas().add(orderCommentFragment);
//        viewPagerAdapter.getDatas().add(orderCancelFragment);

        viewPagerAdapter.getDatas().add(OrderFragment.newInstance(""));//全部
        viewPagerAdapter.getDatas().add(OrderFragment.newInstance("state_new"));//待支付
        viewPagerAdapter.getDatas().add(OrderFragment.newInstance("state_pay"));//代发货
        viewPagerAdapter.getDatas().add(OrderFragment.newInstance("state_send"));//待收货
        viewPagerAdapter.getDatas().add(OrderFragment.newInstance("state_success"));//已完成
        viewPagerAdapter.getDatas().add(OrderFragment.newInstance("state_noeval"));//待评价
        viewPagerAdapter.getDatas().add(OrderFragment.newInstance("state_cancel"));//已取消
...
//        orderDeliverFragment=new OrderDeliverFragment();
