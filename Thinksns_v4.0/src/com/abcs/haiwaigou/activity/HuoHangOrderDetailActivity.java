...
public class HuoHangOrderDetailActivity extends BaseActivity implements View.OnClickListener {
    ...
    @InjectView(R.id.liner_bot)
    LinearLayout liner_bot;
...
//        new LoadDexTask().execute();
        ...
        Log.i("zjz", "storeId=" + storeId);

        if(!TextUtils.isEmpty(storeId)&&storeId.equals("11")){
            liner_bot.setVisibility(View.GONE);
        }
        initDatas();
        setOnListener();
    }
                        ...
                        try {
                            ...
                            if (jsonObject.getInt("code") == 200) {
                                ...
                                if (tvTotalMoney != null)
                                    tvTotalMoney.setText(NumberUtils.formatPriceOuYuan(orderInfoObject.optDouble("goods_amount") + orderInfoObject.optDouble("shipping_fee") - orderInfoObject.optDouble("rcb_amount") - orderInfoObject.optDouble("pd_amount") - orderInfoObject.optDouble("yyg_amount")));
                                if (tTotalMoney != null)
                                    tTotalMoney.setText(NumberUtils.formatPriceOuYuan(orderInfoObject.optDouble("goods_amount") + orderInfoObject.optDouble("shipping_fee") - orderInfoObject.optDouble("rcb_amount") - orderInfoObject.optDouble("pd_amount") - orderInfoObject.optDouble("yyg_amount")));
                                ...
                                if (tFreaght != null)
                                    tFreaght.setText(NumberUtils.formatPriceOuYuan(orderInfoObject.optDouble("shipping_fee")));
                                ...
                                if (relativeChongzhi != null && tChongzhi != null) {
                                    if (!orderInfoObject.optString("rcb_amount").equals("0.00")) {
                                        ...
                                        tChongzhi.setText("-"+NumberUtils.formatPriceOuYuan(orderInfoObject.optDouble("rcb_amount")));
                                    } else {
                                ...
                                if(relativeYucun!=null&&tYucun!=null){
                                    if (!orderInfoObject.optString("pd_amount").equals("0.00")) {
                                        ...
                                        tYucun.setText("-"+NumberUtils.formatPriceOuYuan(orderInfoObject.optDouble("pd_amount")));
                                    } else {
                                ...
                                if(relativeYyg!=null&&tYyg!=null){
                                    if (!orderInfoObject.optString("yyg_amount").equals("0.00")) {
                                        ...
                                        tYyg.setText("-"+NumberUtils.formatPriceOuYuan(orderInfoObject.optDouble("yyg_amount")));
                                    } else {
                                ...
                                if (relativeVouncher != null && tVouncher != null) {
                                    if (!orderCommentObject.optString("voucher_price").equals("null")) {
                                        ...
                                        tVouncher.setText("- " + NumberUtils.formatPriceOuYuan(orderCommentObject.optDouble("voucher_price")));
                                    } else {
                                        isUseVouncher=false;
...
//            } else if (isCancel && !isRefundCancel && !isComplain && !isReceive && !isLock && !isDeliver && !isEvaluation) {
    ...
    private void initGoodsDatas() {
        ...
        for (int i = 0; i < goodsList.size(); i++) {
            ...
            t_goods_price.setText(NumberUtils.formatPriceOuYuan(goodsList.get(i).getMoney()));
            t_goods_num.setText("X" + goodsList.get(i).getGoods_num());
            final int finalI = i;
            img_goods_icon.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Intent intent = new Intent(HuoHangOrderDetailActivity.this, GoodsDetailActivity.class);
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.relative_connect_kefu:
                startActivity(new Intent(this, KefuActivity2.class));
                break;
            ...
            case R.id.t_deliver_code:
                Intent intent = new Intent(HuoHangOrderDetailActivity.this, MyDeliverActivity.class);
    ...
    private void receiveOrder() {
        new PromptDialog(this, "是否确认收货？", new Complete() {
            ...
            public void complete() {
                ProgressDlgUtil.showProgressDlg("Loading...", HuoHangOrderDetailActivity.this);
                                ...
                                try {
                                    ...
                                    if (object.getInt("code") == 200) {
                                        if (object.optString("datas").equals("1")) {
                                            Toast.makeText(HuoHangOrderDetailActivity.this, "成功收货！", Toast.LENGTH_SHORT).show();
                                            MyUpdateUI.sendUpdateCollection(HuoHangOrderDetailActivity.this, MyUpdateUI.ORDER);
                                            finish();
                                        } else {
                                            Toast.makeText(HuoHangOrderDetailActivity.this, "失败！", Toast.LENGTH_SHORT).show();
                                        }
                        ...
                        handler.post(new Runnable() {
                            ...
                            public void run() {
                                try {
                                    ...
                                    if (object.getInt("code") == 200) {
                                        if (object.optString("datas").equals("1")) {
                                            Toast.makeText(HuoHangOrderDetailActivity.this, "成功取消！", Toast.LENGTH_SHORT).show();
                                            MyUpdateUI.sendUpdateCollection(HuoHangOrderDetailActivity.this, MyUpdateUI.ORDER);
                                            finish();
                                        } else {
                                            Toast.makeText(HuoHangOrderDetailActivity.this, "失败！", Toast.LENGTH_SHORT).show();
