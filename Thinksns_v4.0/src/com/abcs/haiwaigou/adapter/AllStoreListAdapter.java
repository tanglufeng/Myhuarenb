...
public class AllStoreListAdapter extends BaseAdapter {
    ...
    public AllStoreListAdapter(Activity activity, ArrayList<Store> goodsList,
                               ZrcListView listView) {
    ...
    public View getView(final int position, View convertView, final ViewGroup parent) {
        ...
        mHolder.t_goods_subname.setText(goods.getAddress());
        ...
        mHolder.rl_root.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra("store_id",goodsList.get(position).getId());
