...
//    MyListView listView;
    ...
    public GoodsAdapter(Activity activity, ArrayList<Goods> goodsList,
                        ZrcListView listView) {
    ...
    public View getView(final int position, View convertView, final ViewGroup parent) {
        ...
        mHolder.t_goods_count.setText(goods.getStore()-goods.getSy_store()+"");
        ...
        mHolder.linear_root.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra("sid",goodsList.get(position).getSid());
