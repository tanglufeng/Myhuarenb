 ...
 */
public class HotGoodsRecyclerViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
    ...
    public HotGoodsRecyclerViewHolder(View itemView) {
        super(itemView);
    }

    public HotGoodsRecyclerViewHolder(View itemView, ItemOnClick itemOnClick) {
        super(itemView);
