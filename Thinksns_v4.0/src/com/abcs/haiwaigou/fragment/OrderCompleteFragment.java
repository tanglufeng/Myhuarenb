 ...
 * 我的订单的页面的已完成的fragment
 */
public class OrderCompleteFragment extends BaseFragment implements RecyclerViewAndSwipeRefreshLayout.SwipeRefreshLayoutRefresh{
...
//                initListView();
    ...
    private void initAllDates() {
        ...
        String   mwjurl=TLUrl.getInstance().URL_hwg_order2 + "&key=" + MyApplication.getInstance().getMykey() + "&order_sn=&query_start_date=&query_end_date=&state_type=state_success&recycle=" + "&curpage=" + currentPage;
        LogUtil.e("mwj",mwjurl);

        HttpRequest.sendPost(TLUrl.getInstance().URL_hwg_order2 + "&key=" + MyApplication.getInstance().getMykey() + "&order_sn=&query_start_date=&query_end_date=&state_type=state_success&recycle=" + "&curpage=" + currentPage, null, new HttpRevMsg() {
            @Override
...
//        JsonObjectRequest jr = new JsonObjectRequest(Request.Method.POST, TLUrl.getInstance().URL_hwg_order2 + "&key=" + MyApplication.getInstance().getMykey() + "&order_sn=&query_start_date=&query_end_date=&state_type=state_success&recycle=" + "&curpage=" + currentPage, null, new Response.Listener<JSONObject>() {
//            @Override
