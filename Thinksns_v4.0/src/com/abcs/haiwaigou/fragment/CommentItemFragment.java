...
//        commentactivity= (GoodsDetailCommentActivity) getActivity();
    ...
    private void initAllDates() {
        ...
        JsonObjectRequest jr = new JsonObjectRequest(Request.Method.POST, TLUrl.getInstance().URL_hwg_goods_comment2 + "&goods_id=" + goods_id + "&type=all" + "&curpage=" + currentPage, null, new Response.Listener<JSONObject>() {
            @Override
