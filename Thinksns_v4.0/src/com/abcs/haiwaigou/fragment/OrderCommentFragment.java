 ...
 */
public class OrderCommentFragment extends BaseFragment implements RecyclerViewAndSwipeRefreshLayout.SwipeRefreshLayoutRefresh{
...
//                initListView();
    ...
    private void initAllDates() {
        ...
        HttpRequest.sendPost(TLUrl.getInstance().URL_hwg_order2 + "&key=" + MyApplication.getInstance().getMykey() + "&order_sn=&query_start_date=&query_end_date=&state_type=state_noeval&recycle=" + "&curpage=" + currentPage, null, new HttpRevMsg() {
            @Override
...
//        JsonObjectRequest jr = new JsonObjectRequest(Request.Method.POST, TLUrl.getInstance().URL_hwg_order2 + "&key=" + MyApplication.getInstance().getMykey() + "&order_sn=&query_start_date=&query_end_date=&state_type=state_noeval&recycle=" + "&curpage=" + currentPage, null, new Response.Listener<JSONObject>() {
//            @Override
