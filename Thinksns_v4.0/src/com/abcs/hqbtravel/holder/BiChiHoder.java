 ...
 */
public class BiChiHoder extends BaseViewHolder<RestauransBean> {
    ...
    public BiChiHoder(ViewGroup parent) {
        super(parent, R.layout.item_travle_bichi);

//        textView.setTypeface(Typeface.createFromAsset(MyApplication.getInstance().getAssets(), "font/lantingxiheigbk.TTF"));
...
//        Util.setlantingxiheiFont(tv_price);
